 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'GmztFkEMUcR8YLToi7Kfap6BgMt4F0Bn');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/trushangts/git1.git');
 ...
 */
define('TARGET_DIR', '/opt/lampp/htdocs/GIT_DEPLOY/git1/');
